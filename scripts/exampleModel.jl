...
function get_example()
  ...
  push!(nodes, sub1)
  push!(nodes, sub2)
  edge1 =  ElecEdge(root, sub1, elec_id)
  elec_id += 1
  edge2 =  ElecEdge(root, sub2, elec_id)
  elec_id += 1
  ...
  d1 =  Node(der, wind, id, x[id], y[id], power1,  sd1, Edge[], Edge[])  
  #create the edge
  edge3 = ElecEdge(sub1, d1, elec_id)
  ...
  d2 =  Node(der, wind, id, x[id], y[id], power2, sd2, Edge[], Edge[]) 
  #create the edge
  edge4 = ElecEdge(sub2, d2, elec_id)
  ...
  edge5 =  ElecEdge(mngmt, sub3, elec_id)
  ...
  cedge1 = ComEdge(com_root, tow1, com_id, 1.0)
